 ...
 */
public class FireProtectionPageObjects extends PageFactoryInitializer {
	...
	public FireProtectionPageObjects verifyFireProtectionPage(String plumbingPageBreadcrumb, String plumbingPageContent) {
